 ...
 */
public class PomodoroEntityDtoMapperTest {
    ...
    @Test
    public void afterMappingEntityToDtoFieldsMustBeEquals() {
    ...
    @Test
    public void afterMappingDtoToEntityFieldsMustBeEquals() {
